...
/**
 * Espejo read-only de /ba/clients/[id]/samples/[sampleId] para Gerente.
 */
export default async function GerenteSampleDetailPage({
  params,
}: {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      >
        <Link
          href={`/gerente/clients/${clientId}/samples`}
