...
/**
 * Espejo read-only de /ba/clients/[id]/purchases para Gerente. El
 * scope se valida en fetchClient (404 silencioso si el cliente cae
 * fuera de la tienda del Gerente). Reusa PurchaseHistory pasándole
 * basePath="/gerente/clients" así los row-links navegan dentro del
 * scope del rol sin caer en el middleware-redirect de /ba.
 */
export default async function GerentePurchasesPage({
  params,
}: {
