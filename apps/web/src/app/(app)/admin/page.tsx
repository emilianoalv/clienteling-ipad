  ...
  return (
    <AdminDashboard
      ...
      data={{
        ...
        storeSparklineByStoreId: Object.fromEntries(storeSparklineByStoreId),
        storeBasByStoreId: Object.fromEntries(storeBasByStoreId),
        storeAlertsByStoreId: Object.fromEntries(storeAlertsByStoreId),
        storeTargetsByStoreId: Object.fromEntries(storeTargetsByStoreId),
        strategicInsights,
        complianceData,
        adoptionData,
        brandTrend,
