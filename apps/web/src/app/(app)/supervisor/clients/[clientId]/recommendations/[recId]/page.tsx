...
/**
 * Espejo read-only de /ba/clients/[id]/recommendations/[recId] para Supervisor.
 */
export default async function SupervisorRecommendationDetailPage({
  params,
}: {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      >
        <Link
          href={`/supervisor/clients/${clientId}/recommendations`}
