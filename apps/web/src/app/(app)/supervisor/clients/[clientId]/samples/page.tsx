...
/**
 * Espejo read-only de /ba/clients/[id]/samples para Supervisor.
 */
export default async function SupervisorSamplesPage({
  params,
}: {
  ...
  const [client, samples, products] = await Promise.all([
    ...
    sampleRepository.listByClient(clientId as ClientId, { brands: brandScopeFor(staff) }),
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      >
        <Link
          href={`/supervisor/clients/${clientId}`}
