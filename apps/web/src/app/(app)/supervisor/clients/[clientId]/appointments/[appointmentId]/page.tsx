 ...
 * para Supervisor. AppointmentDetail recibe readOnly para esconder
 * las acciones (Confirmar / Completar / Reagendar / Cancelar).
 */
export default async function SupervisorAppointmentDetailPage({
  params,
}: {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      >
        <Link
          href={`/supervisor/clients/${clientId}/appointments`}
