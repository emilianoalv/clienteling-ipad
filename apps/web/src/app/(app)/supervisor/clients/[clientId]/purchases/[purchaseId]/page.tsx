...
/**
 * Espejo read-only de /ba/clients/[id]/purchases/[purchaseId] para Supervisor.
 */
export default async function SupervisorPurchaseDetailPage({
  params,
}: {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      >
        <Link
          href={`/supervisor/clients/${clientId}/purchases`}
