 ...
 *
 * One component per role; pages mount them on /ba/performance, /manager,
 * /supervisor, /hq. Numbers are prototype-frozen until F4 wires a real KPI
 * service.
 */
...
export { HqDashboard } from "./components/hq-dashboard";
