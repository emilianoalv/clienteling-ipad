  ...
  return ReactDOM.createPortal(
    <div onClick={() => ctx.setFocus(null)}
      ...
      <div
        ...
        {/* Reset color heredado del overlay (#fff) — si no, los textos sin
            color explícito (display fonts, valores bold) se vuelven blancos
            sobre el paper claro y desaparecen. */}
        <div onClick={(e) => e.stopPropagation()} style={{ width: width * scale, height: height * scale, position: 'relative', color: 'var(--ink)' }}>
